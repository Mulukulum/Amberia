...
################################################################################
## Form generated from reading UI file 'MainWindowirlzlN.ui'
##
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ProjectContents.setGeometry(QRect(0, -85, 177, 563))
    ...
    def AddButtonToProjects(self,Text):
        ...
        for i in Text:
            self.verticalLayout.addWidget(QPushButton(i,self.ProjectScrollArea))
...
if __name__ == "__main__":
    ...
    L=list('12345679891234567896465456456465646465')
