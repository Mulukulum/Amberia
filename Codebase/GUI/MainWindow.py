...
class AmberMainWindow(QtWidgets.QMainWindow):
    ...
    def SetTasksTodayWidgetTitle(self):
        ...
        text=choice(("Today : ","Today is ",'Bucket list for ','Your work for ',"It's already ",f'{abs((datetime.date(2023,2,24)-datetime.date.today()).days)} Days until Boards, today is '))+  (f"{date}" if choice(range(100)) else "Doomsday")  
