...
class AmberWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.ProjectContents.setGeometry(QRect(0, 0, 197, 652))
        self.gridLayout_3 = QGridLayout(self.ProjectContents)
        self.gridLayout_3.setObjectName(u"gridLayout_3")
        self.pushButton_10 = QPushButton(self.ProjectContents)
        self.pushButton_10.setObjectName(u"pushButton_10")

        self.gridLayout_3.addWidget(self.pushButton_10, 18, 0, 1, 1)

        self.pushButton_3 = QPushButton(self.ProjectContents)
        self.pushButton_3.setObjectName(u"pushButton_3")

        self.gridLayout_3.addWidget(self.pushButton_3, 9, 0, 1, 1)

        self.pushButton_15 = QPushButton(self.ProjectContents)
        self.pushButton_15.setObjectName(u"pushButton_15")

        self.gridLayout_3.addWidget(self.pushButton_15, 10, 0, 1, 1)

        self.pushButton_19 = QPushButton(self.ProjectContents)
        self.pushButton_19.setObjectName(u"pushButton_19")

        self.gridLayout_3.addWidget(self.pushButton_19, 7, 0, 1, 1)

        self.edit_amberlabels_button = QPushButton(self.ProjectContents)
        self.edit_amberlabels_button.setObjectName(u"edit_amberlabels_button")
        self.edit_amberlabels_button.setStyleSheet(u"background: rgb(255, 255, 127)")

        self.gridLayout_3.addWidget(self.edit_amberlabels_button, 0, 0, 1, 1)

        self.pushButton_11 = QPushButton(self.ProjectContents)
        self.pushButton_11.setObjectName(u"pushButton_11")

        self.gridLayout_3.addWidget(self.pushButton_11, 17, 0, 1, 1)

        self.pushButton_12 = QPushButton(self.ProjectContents)
        self.pushButton_12.setObjectName(u"pushButton_12")

        self.gridLayout_3.addWidget(self.pushButton_12, 16, 0, 1, 1)

        self.pushButton_17 = QPushButton(self.ProjectContents)
        self.pushButton_17.setObjectName(u"pushButton_17")

        self.gridLayout_3.addWidget(self.pushButton_17, 12, 0, 1, 1)

        self.pushButton_13 = QPushButton(self.ProjectContents)
        self.pushButton_13.setObjectName(u"pushButton_13")

        self.gridLayout_3.addWidget(self.pushButton_13, 15, 0, 1, 1)

        self.pushButton_6 = QPushButton(self.ProjectContents)
        self.pushButton_6.setObjectName(u"pushButton_6")

        self.gridLayout_3.addWidget(self.pushButton_6, 21, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.tasks_today_button, 1, 0, 1, 1)

        self.pushButton = QPushButton(self.ProjectContents)
        self.pushButton.setObjectName(u"pushButton")

        self.gridLayout_3.addWidget(self.pushButton, 24, 0, 1, 1)

        self.pushButton_16 = QPushButton(self.ProjectContents)
        self.pushButton_16.setObjectName(u"pushButton_16")

        self.gridLayout_3.addWidget(self.pushButton_16, 13, 0, 1, 1)

        self.pushButton_5 = QPushButton(self.ProjectContents)
        self.pushButton_5.setObjectName(u"pushButton_5")

        self.gridLayout_3.addWidget(self.pushButton_5, 22, 0, 1, 1)

        self.pushButton_9 = QPushButton(self.ProjectContents)
        self.pushButton_9.setObjectName(u"pushButton_9")

        self.gridLayout_3.addWidget(self.pushButton_9, 19, 0, 1, 1)

        self.pushButton_8 = QPushButton(self.ProjectContents)
        self.pushButton_8.setObjectName(u"pushButton_8")

        self.gridLayout_3.addWidget(self.pushButton_8, 20, 0, 1, 1)

        self.pushButton_4 = QPushButton(self.ProjectContents)
        self.pushButton_4.setObjectName(u"pushButton_4")

        self.gridLayout_3.addWidget(self.pushButton_4, 23, 0, 1, 1)

        self.pushButton_2 = QPushButton(self.ProjectContents)
        self.pushButton_2.setObjectName(u"pushButton_2")

        self.gridLayout_3.addWidget(self.pushButton_2, 25, 0, 1, 1)

        self.pushButton_14 = QPushButton(self.ProjectContents)
        self.pushButton_14.setObjectName(u"pushButton_14")

        self.gridLayout_3.addWidget(self.pushButton_14, 14, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.pushButton_18, 11, 0, 1, 1)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.edit_amberlabels_button.setText(QCoreApplication.translate("MainWindow", u"Labels", None))
